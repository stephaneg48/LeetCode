class Solution:
    def superPow(self, a, b):
        # real problem is how the large integer is stored
        import math
        x = a
        exp = ""
        for num in b:
        ...
        def power(x, p, n):
            if p == 1:
                return x % n
            # won't work without integer division, of course...
            t = power(x, math.floor(p//2), n)
            t = (t * t) % n
            if p % 2 == 1:
                t = (t * x) % n
            return t
